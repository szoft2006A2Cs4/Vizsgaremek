export default function ASzF({value, setter}){
    ...
    return(
        <Dialog.Root open={value} onOpenChange={(e) => setter(e.open)}>
        <Portal>
          <Dialog.Backdrop />
          <Dialog.Positioner>
            <Dialog.Content>
  ...
  <div className="aszf_div">
    ...
    <div style={{ display: 'grid', gap: '4px' }}>
      <div><strong>Név/Cégnév:</strong> Használt Hangszerek</div>
      <div><strong>Székhely/Lakcím:</strong> Szombathely</div>
      <div><strong>E-mail cím:</strong> <a href="mailto:hasznalthangszerek01@gmail.com">hasznalthangszerek01@gmail.com</a></div>
      <div><strong>Honlap:</strong> <a href="https://hasznalthangszerek.hu" target="_blank">használthangszerek.hu</a></div>
    </div>
  </div>
  ...
  <div className="aszf_div">
    ...
    <p>A megadott adatokat a cél megvalósulásáig (pl. a kérdés megválaszolásáig) vagy a hozzájárulás visszavonásáig tárolom.</p>
  </div>

  <div className="aszf_div">
    <h4 className="aszf_cim">5. Adatfeldolgozók (Tárhelyszolgáltató):</h4>
    <p>Az adatokat biztonságos szervereken tároljuk. Tárhelyszolgáltatónk:</p>
    <div>
      <strong>aiven.io</strong>, Helsinki, Finland (HQ)<br />
      Antinkatu 1., <a href="mailto:sales@aiven.io">sales@aiven.io</a>
    </div>
  </div>
  ...
  <div  className="aszf_div">
    ...
    <p>Bármilyen adatvédelmi panasszal a <strong>Nemzeti Adatvédelmi és Információszabadság Hatósághoz (NAIH)</strong> fordulhatsz:</p>
    <ul style={{ listStyle: 'none', padding: 0 }}>
      <li><strong>Web:</strong> <a href="https://www.naih.hu" target="_blank">www.naih.hu</a></li>
